...
IntroTagColor = 'FF5F5F'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	setTextSize('JukeBoxText', IntroTextSize)
        setTextColor('JukeBoxText', 'FF5F5F')
	addLuaText('JukeBoxText')
	
	--text for the song name
	makeLuaText('JukeBoxSubText', 'By Flipworksinstuff, Pepprmintyy, and Seberster', 300, -305-IntroTagWidth, 60)
...
end -- UH IDK WHO MADE THIS SCRIPT BUT I GOT IT FROM THIS https://github.com/FridayNightGachaTrap/Psych-Engine-Deluxe/releases/tag/v4.0.0